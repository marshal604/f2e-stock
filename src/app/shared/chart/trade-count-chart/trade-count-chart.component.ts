import {
  ...
  ElementRef,
  Input
} from './node_modules/@shared/chart/trade-count-chart/node_modules/@angular/core';

import * as d3 from './node_modules/@shared/chart/trade-count-chart/node_modules/d3';
import { StockOverCountTradeCount } from './node_modules/@stock-over-count/stock-over-count.model';

@Component({
  selector: 'yur-trade-count-chart',
  templateUrl: './trade-count-chart.component.html',
  styleUrls: ['./trade-count-chart.component.scss']
})
export class TradeCountChartComponent implements OnInit, AfterViewInit, OnDestroy {
  @Input()
  chartData: StockOverCountTradeCount[];
